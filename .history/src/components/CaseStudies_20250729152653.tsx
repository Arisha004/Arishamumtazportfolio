...
const CaseStudies = () => {
  const caseStudies = [
    {
      title: "AI-Powered E-Commerce Redesign",
      client: "TechFlow Solutions",
      category: "UX/UI Design",
      duration: "3 months",
      challenge: "Increase conversion rates and reduce cart abandonment",
      solution: "Implemented AI-driven product recommendations and streamlined checkout process",
      results: [
    ...
    {
      title: "Healthcare App for Senior Citizens",
      client: "MediCare Plus",
      category: "Mobile UX Design",
      duration: "4 months",
      challenge: "Create an accessible healthcare app for elderly users",
      solution: "Designed large touch targets, voice navigation, and simplified AI-assisted health tracking",
      results: [
    ...
    },
    {
      ...
      duration: "2 months",
      challenge: "Simplify complex financial data visualization",
