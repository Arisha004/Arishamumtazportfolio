  ...
  const projects = [
    {
      ...
      description: "Built with Lovable AI and Firebase, featuring intelligent product recommendations and automated customer service.",
      tags: ["React", "Vite", "Lovable AI", "TypeScript","TailwindCSS"],
