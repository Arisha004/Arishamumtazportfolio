...
{!loaded && (
  <div className="absolute inset-0 bg-transparent rounded-xl" />
      ...
      {showMessage && (
        <div
          className="absolute -top-10 left-8px transform -translate-x-1/2 bg-black dark:bg-card px-4 py-2 rounded-2xl shadow-lg border border-border animate-fade-in whitespace-nowrap z-10"
          style={{
