    ...
    <div className={cn("relative flex flex-col items-center", className)}>
      ...
      {showMessage && (
        ...
        >
          ...
          {/* Speech bubble tail */}
          <div 
            className="absolute top-full left-20px transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-white dark:border-t-card"
          />
        </div>
      )}
    </div>
