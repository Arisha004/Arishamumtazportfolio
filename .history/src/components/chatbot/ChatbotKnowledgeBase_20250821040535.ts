...
export const knowledgeBase: KnowledgeItem[] = [
  ...
  {
    keywords: ['experience', 'background', 'work history', 'portfolio'],
    response: "I'm a dedicated Frontend Developer and UI/UX Designer with extensive experience in:\n\n💻 **Web Development** - Building responsive, dynamic websites\n🎨 **Design Systems** - Creating cohesive visual experiences\n🚀 **Client Projects** - Delivering solutions from concept to deployment\n📈 **Professional Growth** - 500+ LinkedIn connections in the tech industry\n\nI'm passionate about staying current with the latest web technologies and design trends!",
    category: 'experience'
  },
