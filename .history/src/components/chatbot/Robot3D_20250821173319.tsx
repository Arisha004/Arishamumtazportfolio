...
const Robot3D: React.FC<Robot3DProps> = ({ onMessageShow, className }) => {
  ...
  return (
    <div className={cn("relative flex flex-col items-center", className)}>
      ...
      {showMessage && (
        <div 
          className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-white dark:bg-card px-4 py-2 rounded-2xl shadow-lg border border-border animate-fade-in whitespace-nowrap z-10"
          style={{
