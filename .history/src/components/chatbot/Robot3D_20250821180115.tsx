...
{!loaded && (
  <div className="absolute inset-0 bg-transparent rounded-xl" />
        ...
        {/* Robot Image */}
        <img
          src="./images/robot.png" // 👈 change this to your robot image path
          alt="Robot"
      ...
      {showMessage && (
        <div
          className="absolute -top-12 left-20px transform -translate-x-1/2 bg-black dark:bg-card px-4 py-2 rounded-2xl shadow-lg border border-border animate-fade-in whitespace-nowrap z-10"
          style={{
