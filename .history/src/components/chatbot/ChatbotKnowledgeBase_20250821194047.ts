...
export const knowledgeBase: KnowledgeItem[] = [
  ...
  },
  {
    ...
    response: "You're welcome! 😊 Don’t forget to check out Arisha’s LinkedIn: [My L](https://www.linkedin.com/in/arisha-mumtaz/) and her portfolios to see her work in action.",
    category: 'general'
  }
];
