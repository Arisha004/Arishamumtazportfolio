...
export const knowledgeBase: KnowledgeItem[] = [
  ...
  },
  {
    ...
    response: "You're welcome! 😊 Don’t forget to check out Arisha’s LinkedIn: [linkedin.com/in/arisha-mumtaz](https://www.linkedin.com/in/arisha-mumtaz/) and her portfolios to see her work in action.",
    category: 'general'
  }
];
