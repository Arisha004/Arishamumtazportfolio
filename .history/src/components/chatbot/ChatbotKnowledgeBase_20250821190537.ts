...
export const knowledgeBase: KnowledgeItem[] = [
  // About Arisha
  {
    ...
    response: "Hi! I'm Arisha Mumtaz, a passionate UI/UX Designer and Front-End Developer based in Karachi, Pakistan. I specialize in creating dynamic, user-friendly web interfaces with a focus on both functionality and visual appeal. I have over 500+ professional connections and love bringing creative ideas to life through code and design!I build full-stack applications with a strong focus on problem-solving and real-world implementation. My expertise covers both front-end (HTML, CSS, JavaScript, Figma, Webflow) and back-end (PHP, Laravel, database management) development. I’ve worked with platforms like Lovable and Replit to deliver deployable, tested solutions. Unlike a vibe coder, I approach projects with structured thinking—designing, implementing, testing, and solving problems efficiently to deliver scalable applications.",
    category: 'about'
  },
