...
const Hero = () => {
  ...
  const downloadResume = () => {
    // Create a dummy resume download - in real implementation, this would download an actual PDF
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-50 left-10 w-20 h-20 bg-primary/30 rounded-full blur-xl animate-float-1"></div>
        ...
        <div className="hero-content">
          ...
          <div className="flex items-center justify-center mb-8 animate-fade-in">
            <div className="flex items-center bg-gradient-to-r from-primary/20 to-accent/20 rounded-full px-6 py-3 border border-primary/30 backdrop-blur-sm">
              ...
              <span className="text-primary font-bold tracking-wider uppercase text-sm mt-30px">
          ...
          <div className="max-w-5xl mx-auto mb-12 animate-fade-in-up">
            <p className="text-xl md:text-2xl lg:text-3xl text-foreground/90 mb-6 leading-relaxed">
              ...
              <span className="text-primary-glow font-black">AI-powered development</span>.
            </p>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              ...
              <span className="text-secondary font-semibold">cutting-edge tools</span>.
            </p>
            <div className="flex items-center justify-center mt-6 space-x-6">
              ...
              <div className="flex items-center text-accent">
                ...
                <span className="font-semibold">100+ AI Projects</span>
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce-slow z-50">
