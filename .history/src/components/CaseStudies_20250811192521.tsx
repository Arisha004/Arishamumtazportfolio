...
const CaseStudies = () => {
  const caseStudies = [
    ...
    {
  title: "Bitcoin Trading Platform Case Study",
  category: "UX/UI Design",
  duration: "3 months",
  challenge: "Enhance user trust and usability for a Bitcoin trading interface",
  solution: "Redesigned the dashboard with real-time price tracking, intuitive trading flows, and AI-driven insights",
  results: [
    { metric: "User Trust Score", improvement: "+78%" },
    { metric: "Trade Completion Rate", improvement: "+142%" },
  ...
  testimonial: "Arisha's UX strategy made our Bitcoin trading experience smoother and more trustworthy, driving record-breaking revenue.",
                ...
                <CardContent className={`p-8 lg:p-12 flex flex-col justify-center ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                  <div className="space-y-6">
                    ...
                    <Button className="btn-ai w-fit group">
                     ...
                     <a href="https://www.figma.com/design/WkDujBhRcGN8psabCdU3uI/BITCOIN-WALLET?node-id=0-1&p=f&t=vJEQLJYvFhvKWwzH-0"></a> View Full Case Study
