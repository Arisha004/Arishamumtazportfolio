...
const CaseStudies = () => {
  ...
  {
  title: "Bitcoin Wallet Case Study",
  category: "UX/UI Design",
  duration: "3 months",
  challenge: "Improve security perception and streamline cryptocurrency wallet usability for beginners and experienced users",
  solution: "Redesigned the wallet interface with biometric authentication, one-tap send/receive, and real-time balance updates. Integrated transaction history visualization and AI-powered fraud detection alerts.",
  results: [
    { metric: "User Trust Score", improvement: "+78%" },
    { metric: "Transaction Completion Rate", improvement: "+156%" },
    { metric: "Daily Active Users", improvement: "+92%" },
    { metric: "Wallet Retention Rate", improvement: "+64%" }
  ],
  ...
  testimonial: "Arisha's redesign made our Bitcoin wallet both highly secure and incredibly easy to use, resulting in a huge boost in adoption and retention.",
  figmaLink: "https://www.figma.com/design/WkDujBhRcGN8psabCdU3uI/BITCOIN-WALLET?node-id=62-2&t=vJEQLJYvFhvKWwzH-0"
}
...
testimonial: "Arisha turned our complex healthcare platform into something our users actually enjoy using daily.",
    }
  ];
                ...
                <CardContent className={`p-8 lg:p-12 flex flex-col justify-center ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                  <div className="space-y-6">
                    ...
                    <Button className="btn-ai w-fit group">
                     ...
                     <a href="https://www.figma.com/design/WkDujBhRcGN8psabCdU3uI/BITCOIN-WALLET?node-id=0-1&p=f&t=vJEQLJYvFhvKWwzH-0">View Full Case Study</a>
